    ...
    <section className="container bg-black rounded-b-[40px] mx-auto px-8 py-12 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      >
        <div className="space-y-4">
          ...
          >
            Transformez vos idées en applications innovantes
          </motion.p>
        </div>
        ...
        >
          {[
            {
              title: "5+ ans d'expérience en développement",
              subtitle: "Expertise en React, React Native et Node.js"
            },
            {
              title: "Solutions sur mesure et évolutives",
              subtitle: "Architectures robustes pour startups et grandes entreprises"
            },
            {
              title: "Approche axée sur les résultats",
              subtitle: "Optimisation des performances et de l'expérience utilisateur"
            }
          ].map((item, index) => (
            <motion.li 
              key={index}
